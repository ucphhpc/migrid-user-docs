...
Thus, we generally recommend looking at one of the SFTP-based solutions, where `SSHFS with SFTP </sections/erda/networkdrive/sshfs/index>` is a popular option if performance and stability is a concern.

With that being said, you can find our guide for Windows and MacOS linked below. If you are interested in a file synchronisation service resembling Dropbox, but which you are permitted to use as a KU Employee, then you can also check out Seafile, also linked below.
